 ...
 * 
 * Anda dapat mengubah path file di bawah ini jika ingin mengganti gambar
 * latar belakang, logo institusi, atau ikon navigasi pada GitHub Pages / static hosting.
 */
...
window.MPI_CONFIG = {
    ...
    // ------------------------------------------------------------
    meta: {
        title: 'Berpikir Komputasional — Algoritma di Balik Rumah Cerdas (IoT)',
        subject: 'Informatika',
        grade: 'Kelas IX / Semester I (Ganjil)',
        phase: 'Fase D',
